    ...
    <>
      ...
      <div className="main-grid">
        <div className="main-grid__item">
          ...
          <Filter
            handleFilterItemABV={handleFilterItemABV}
            handleFilterItemClassic={handleFilterItemClassic}
            handleFilterItemPh={handleFilterItemPh}
          />
        </div>
        <div>
          <BeerDisplay
            ...
            filterItemABV={filterItemABV}
            filterItemClassic={filterItemClassic}
            filterItemPh={filterItemPh}
          />
        </div>
      </div>
    </>
